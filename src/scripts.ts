...
function filterCourses(products: Product[]) {
...
const titlesGet = getTitles(products);
...
const priceFormatting = formatPrice(products[0])
...
const anyProduct: Product2 = {title: "glass", price: 10}
